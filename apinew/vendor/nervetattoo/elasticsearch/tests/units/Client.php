...
class Client extends \ElasticSearch\tests\Base
{
    public function tearDown() {
        ...
        \ElasticSearch\Client::connection()->setIndex('yy-index')->delete();
        \ElasticSearch\Client::connection()->delete();
    }

    public function testDsnIsCorrectlyParsed() {
        $search = \ElasticSearch\Client::connection('http://yy.com:9100/index/type');
        $config = array(
            'protocol' => 'http',
            'servers' => 'yy.com:9100',
            'index' => 'index',
    ...
    public function testSearchMultipleIndexes()
    {
        ...
        $primaryIndex = 'yy-index';
        $secondaryIndex = 'yy-index2';
        $doc = array('title' => $tag);
        $options = array('refresh' => true);
